...
from .image_encoder_ori import ImageEncoderViT
from .mask_decoder_2d import MaskDecoder
from .prompt_encoder_2d import PromptEncoder
...
class Sam(nn.Module):
    ...
    def forward(
        ...
        """
        print("batched_input:", type(batched_input))
